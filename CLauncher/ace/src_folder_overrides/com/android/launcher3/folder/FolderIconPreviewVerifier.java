...
public class FolderIconPreviewVerifier {
    ...
    public void setFolderInfo(FolderInfo info) {
        ...
        //liuzuo:fix preview item bug:begin
        //mGridCountX = mGridSize[0];
        mGridCountX = (int) Math.sqrt(FolderIcon.NUM_ITEMS_IN_PREVIEW);
        //liuzuo:fix preview item bug:end
        mDisplayingUpperLeftQuadrant = numItemsInFolder > FolderIcon.NUM_ITEMS_IN_PREVIEW;
    }
