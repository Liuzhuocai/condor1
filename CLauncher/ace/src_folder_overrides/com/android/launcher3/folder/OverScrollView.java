 ...
 *
 * <p>Never add a {@link androidx.appcompat.widget.RecyclerView} or {@link android.widget.ListView} to
...
public class OverScrollView extends FrameLayout {
    ...
    static final int SCROLL_TRACE_DELAY = 100;
    ...
    private void invalidateParentIfNeededInner() {
    ...
    public void setOverScrollMode(int mode) {
        if (mode != OVER_SCROLL_NEVER) {
            if (mEdgeGlowTop == null) {
                mEdgeGlowTop = createTopEdgeEffect();
                mEdgeGlowBottom = createBottomEdgeEffect();
            }
        } else {
            mEdgeGlowTop = null;
