...
public class Folder extends AbstractFloatingView implements DragSource,
    ...
    @Thunk
    com.android.launcher3.folder.FolderIcon mFolderIcon;

    @Thunk
    com.android.launcher3.folder.FolderPagedView mContent;
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        if (sHintText == null) {
            ...
            String s = res.getString(R.string.folder_name);
            if("".equals(s)){
    ...
    protected void onFinishInflate() {
        ...
        mContent = (com.android.launcher3.folder.FolderPagedView) findViewById(R.id.folder_content);
    ...
    public boolean onLongClick(View v) {
        ...
        if (SCREEN_LOCKED.value()) {
            mLauncher.getWorkspace().showPopupContainer(v, new DragOptions());
            ToastHelper.showMessage(mLauncher, R.string.msg_desktop_is_locked);
            return true;
        }
        ...
        if(!mLauncher.getImportMode()&&!mLauncher.isInState(EDIT_MODE) )
    ...
    public com.android.launcher3.folder.FolderIcon getFolderIcon() {
        return mFolderIcon;
    }
    ...
    public void setFolderIcon(com.android.launcher3.folder.FolderIcon icon) {
        mFolderIcon = icon;
    }
    ...
    public void animateOpen() {
        ...
        AnimatorSet anim = new com.android.launcher3.folder.FolderAnimationManager(this, true /* isOpening */).getAnimator();
...
//            mFolderName.setTranslationX(0);
    ...
    protected void handleClose(boolean animate) {
        ...
        //M:liuzuo:update indicator:begin
        if(mLauncher.getWorkspace()!=null && mLauncher.getWorkspace().getPageIndicator()!=null){
            mLauncher.getWorkspace().getPageIndicator().setAlpha(1f);
            mLauncher.getWorkspace().getPageIndicator().setVisibility(View.VISIBLE);
        }
        //M:liuzuo:update indicator:end
        mLauncher.workspaceAnimationForCloseFolder(this);
    ...
    private void animateClosed() {
        AnimatorSet a = new com.android.launcher3.folder.FolderAnimationManager(this, false /* isOpening */).getAnimator();
        a.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                // Perry: locate application function: start
...
//        }
    ...
    public void getHitRectRelativeToDragLayer(Rect outRect) {
        ...
        //liuzuo:drag area:begin
        outRect.top +=mFooterHeight;
        //liuzuo:drag area:end
    ...
    public BubbleTextView findShortcutByAppInfo(AppInfo app) {
        return (BubbleTextView) mContent.iterateOverItems((info, view)->
                app.getTargetComponent().equals(info.getTargetComponent())
    ...
    private void locationAfterOpen(final BubbleTextView app) {
        int page = mContent.getPageOfItem(app);
        if (page > 0) {
            mContent.setDelayedSnapToPageRunnable(() -> {
    ...
    public void onImportModeClick(View v,ShortcutInfo tag){
        ...
        if( v instanceof BubbleTextView){
            ...
            mLauncher.onImportModeClick(v,  tag);
    }
