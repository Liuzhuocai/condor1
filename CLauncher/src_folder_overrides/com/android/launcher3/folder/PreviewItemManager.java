...
public class PreviewItemManager {
    ...
    private void computePreviewDrawingParams(int drawableSize, int totalSize) {
        if (mIntrinsicIconSize != drawableSize || mTotalWidth != totalSize ||
            ...
            mIcon.mPreviewLayoutRule.init(mIcon.mBackground.previewSize, mIntrinsicIconSize,
                    Utilities.isRtl(mIcon.getResources()),mIcon.getResources());
    ...
    public void hidePreviewItem(int index, boolean hidden) {
        ...
        //liuzuo:remove for foldericon:start
        //index = index + Math.max(mFirstPageParams.size() - FolderIcon.NUM_ITEMS_IN_PREVIEW, 0);
        //liuzuo:remove for foldericon:end
    ...
    public void onDrop(List<BubbleTextView> oldParams, List<BubbleTextView> newParams,
        ...
        for (int i = 0; i < moveOut.size(); ++i) {
            ...
            updateTransitionParam(p, item, oldIndex, mIcon.mPreviewLayoutRule.getEnterIndex(), numItems);
