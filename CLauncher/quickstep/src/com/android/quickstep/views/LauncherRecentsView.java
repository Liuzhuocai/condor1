...
public class LauncherRecentsView extends RecentsView<Launcher> {
    ...
    public AnimatorSet createAdjacentPageAnimForTaskLaunch(TaskView tv,
        ...
        anim.play(ObjectAnimator.ofFloat(
                mActivity.getOverviewPanel(), CLEAR_ALL_BUTTON_PROGRESS, allAppsProgressOffscreen));
        ObjectAnimator clearAllButtonAlphaAnim = ObjectAnimator.ofFloat(
                mActivity.getOverviewPanel(), CLEAR_ALL_BUTTON_ALPHA, 0);
        clearAllButtonAlphaAnim.setInterpolator(Interpolators.DEACCEL_3);
        anim.play(clearAllButtonAlphaAnim);
