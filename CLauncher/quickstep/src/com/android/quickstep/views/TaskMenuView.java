...
import com.condor.launcher.CondorTaskSystemShortcut;
...
public class TaskMenuView extends AbstractFloatingView {
    ...
    public static final TaskSystemShortcut[] MENU_OPTIONS = CondorTaskSystemShortcut.
            getTaskSystemShortcuts();
    ...
    private void addMenuOptions(TaskView taskView) {
        // Perry: Implement Lock/Unlock task function: start
        Drawable icon = taskView.getTaskIcon().getConstantState().newDrawable();
        // Perry: Implement Lock/Unlock task function: end
