...
import static com.android.quickstep.views.RecentsView.CLEAR_ALL_BUTTON_PROGRESS;
...
public class RecentsViewStateController implements StateHandler {
    ...
    public void setState(LauncherState state) {
        ...
        mRecentsView.setClearAllButtonProgress(OVERVIEW.getVerticalProgress(mLauncher));
    ...
    public void setStateWithAnimation(final LauncherState toState,
        ...
        // Perry: Add clear all button to recents: start
        setter.setFloat(mRecentsView, CLEAR_ALL_BUTTON_PROGRESS, OVERVIEW.getVerticalProgress(mLauncher),
                LINEAR);
        // Perry: Add clear all button to recents: end
