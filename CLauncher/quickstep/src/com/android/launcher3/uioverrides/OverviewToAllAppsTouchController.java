...
public class OverviewToAllAppsTouchController extends PortraitStatesTouchController {
    ...
    protected boolean canInterceptTouch(MotionEvent ev) {
        ...
        if (mLauncher.isInState(ALL_APPS)) {
            ...
            // Perry: Can't slide to allapps from workspace in default mode: start
            return DesktopModeHelper.isClassicMode();
            // Perry: Can't slide to allapps from workspace in default mode: end
