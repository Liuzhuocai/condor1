...
public class OverviewState extends LauncherState {
    ...
    public static float getDefaultSwipeHeight(Launcher launcher) {
        ...
        return dp.allAppsSearchBarFieldHeightPx + dp.allAppsIconSizePx + dp.allAppsIconTextSizePx
                + (dp.isMultiWindowMode ? Utils.dp2px(launcher, 5) : 0);
