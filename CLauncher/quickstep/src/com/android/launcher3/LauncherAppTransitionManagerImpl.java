...
public class LauncherAppTransitionManagerImpl extends LauncherAppTransitionManager
    ...
    private Pair<AnimatorSet, Runnable> getLauncherContentAnimator(boolean isAppOpening) {
        ...
        if (mLauncher.isInState(ALL_APPS)) {
            ...
            launcherAnimator.play(ObjectAnimator.ofFloat(mLauncher.getOverviewPanel(),
                    CLEAR_ALL_BUTTON_PROGRESS, allAppsController.getProgress(), ALL_APPS_PROGRESS_OFF_SCREEN));
