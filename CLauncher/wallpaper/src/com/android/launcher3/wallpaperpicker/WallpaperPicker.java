...
public class WallpaperPicker extends RecyclerView {
    ...
    static class PickImageInfo extends WallpaperTileInfo {
        @Override
        public void onClick(Activity a) {
            //liuzuo:fit condor theme:begin
            try {
                Intent intent = new Intent();
                intent.setClassName("dz.condor.ThemeParc","com.condor.condortheme.ui.CategoriesListActivity");
                intent.setFlags(Intent.FLAG_RECEIVER_FOREGROUND);
                intent.setType("image/*");
                a.startActivityForResult(intent, IMAGE_PICK);
            //liuzuo:fit condor theme:start
    ...
    public static class LiveWallpaperInfo extends WallpaperTileInfo {
        ...
        public void onClick(Activity a) {
            try {
                ...
                Toast.makeText(a,R.string.not_supported_live_wallpaper,Toast.LENGTH_SHORT).show();
            }
   ...
   static BitmapCropTask cropTask;
    static void setWallpaperNoCrop(Context context, Uri uri,
        ...
        cropTask.executeOnExecutor(AsyncTask.SERIAL_EXECUTOR);//liuzuo change execute to  executeOnExecutor
    }
