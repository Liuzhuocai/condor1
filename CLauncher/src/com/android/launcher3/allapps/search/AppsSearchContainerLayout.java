...
import com.condor.launcher.search.FuzzySearchAlgorithm;
...
public class AppsSearchContainerLayout extends ExtendedEditText
    ...
    public void initialize(AllAppsContainerView appsView) {
        ...
        mSearchBarController.initialize(
                new FuzzySearchAlgorithm(getContext(), mApps), this, mLauncher, this);
    ...
    @Override
    public void onSearchResult(String query, ArrayList<SearchKey> apps) {
        if (apps != null) {
    ...
    public void setInsets(Rect insets) {
        ...
        if (dp.isVerticalBarLayout()) {
            ...
            mLauncher.getAllAppsController().setScrollRangeDelta(
                    insets.bottom + mlp.topMargin + dp.allAppsIconSizePx - getPaddingTop());
    ...
    private void resetTranslationY() {
        ...
        setTranslationY(dp.getAllAppsSearchBarTranslationY(getContext()));
