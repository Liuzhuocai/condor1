...
public class Interpolators {
    ...
    public static final Interpolator Z_0_5 = new ZInterpolator(0.5f);
    public static final Interpolator ACCEL_0_9 = new AccelerateInterpolator(0.9f);
    public static final Interpolator DEACCEL_4 = new DecelerateInterpolator(4);
    ...
    private static class ZInterpolator implements Interpolator {
