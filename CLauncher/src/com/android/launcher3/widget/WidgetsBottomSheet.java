...
public class WidgetsBottomSheet extends BaseWidgetSheet implements Insettable {
    ...
    private WidgetCell addItemCell(ViewGroup parent) {
        WidgetCell widget = (WidgetCell) LayoutInflater.from(getContext()).inflate(
                R.layout.widget_cell_bottom, parent, false);
    ...
    // Perry: Adjust navigation bar color for WidgetsBottomSheet: start
    @Override
    ...
    // Perry: Adjust navigation bar color for WidgetsBottomSheet: end
