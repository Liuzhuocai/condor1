...
public class WidgetCell extends LinearLayout implements OnLayoutChangeListener {
    ...
    private static final float WIDTH_SCALE = 1.545f;
    ...
    protected void onFinishInflate() {
        ...
        //liuzuo :widget_cell_content :start
        Utils.setClipViewCornerRadius(mWidgetImage,getResources().getDimensionPixelSize(R.dimen.widget_cell_radius));
        //liuzuo :widget_cell_content :end
    }
    ...
    public void setLayoutParams(ViewGroup.LayoutParams params) {
        //liuzuo :widget_cell_content :start
        params.height = (int) (mCellSize*1.26f);
        //liuzuo :widget_cell_content :end
