...
import com.condor.launcher.layoutloader.BaseLayoutLoader;
import com.condor.launcher.layoutloader.BaseLayoutLoader.LayoutParserCallback;
import com.condor.launcher.layoutloader.AutoInstallsLayout;
import com.condor.launcher.layoutloader.DefaultLayoutLoader;
import com.condor.launcher.layoutloader.ExternalLayoutLoader;
...
public class LauncherProvider extends ContentProvider {
    ...
    public Bundle call(String method, final String arg, final Bundle extras) {
        ...
        switch (method) {
            ...
            case LauncherSettings.Settings.METHOD_CHANGE_DATABASE: {
                mOpenHelper.close();
                mOpenHelper = null;
                return null;
            }
    ...
    private void clearFlagEmptyDbCreated() {
        DesktopModeHelper.erasureDbCreatedMark();
    }
    ...
    synchronized private void loadDefaultFavoritesIfNecessary() {
        if (DesktopModeHelper.isDbCreated()) {
            Log.d(TAG, "loading default workspace");

            AppWidgetHost widgetHost = mOpenHelper.newLauncherWidgetHost();
            // Perry: external layout loader: start
            BaseLayoutLoader loader = null;
            if (CondorFeatureFlags.SUPPORT_AUTO_INSTALLS_LAYOUT) {
                ...
                if (loader == null) {
                    ...
                    if (partner != null && partner.hasDefaultLayout()) {
                        ...
                        if (workspaceResId != 0) {
                            loader = new DefaultLayoutLoader(getContext(), widgetHost,
            ...
            if (loader == null) {
                loader = getExternalLayoutParser(widgetHost);
            }
    ...
    // Perry: external layout loader: start
    private ExternalLayoutLoader getExternalLayoutParser(AppWidgetHost widgetHost) {
        String defaultLayout = DesktopModeHelper.getLayoutFile(getContext());
        return new ExternalLayoutLoader(getContext(), widgetHost,
                mOpenHelper, getContext().getResources(), defaultLayout);
    }

    private DefaultLayoutLoader getDefaultLayoutParser(AppWidgetHost widgetHost) {
        InvariantDeviceProfile idp = LauncherAppState.getIDP(getContext());
        int defaultLayout = DesktopModeHelper.getLayoutResId(getContext());
        if (defaultLayout == 0) {
        ...
        return new DefaultLayoutLoader(getContext(), widgetHost,
                mOpenHelper, getContext().getResources(), defaultLayout);
    }
    // Perry: external layout loader: end
    ...
    public static class DatabaseHelper extends NoLocaleSQLiteHelper implements LayoutParserCallback {
        ...
        DatabaseHelper(Context context, Handler widgetHostResetHandler) {
            this(context, widgetHostResetHandler, DesktopModeHelper.getDbFile());
        ...
        protected void onEmptyDbCreated() {
            ...
            DesktopModeHelper.markDbCreated();
        }
        ...
        @Thunk int loadFavorites(SQLiteDatabase db, BaseLayoutLoader loader) {
