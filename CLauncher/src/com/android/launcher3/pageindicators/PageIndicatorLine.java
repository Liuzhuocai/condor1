 ...
 */
public class PageIndicatorLine extends View implements Insettable, PageIndicator {
    ...
    public PageIndicatorLine(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PageIndicatorLine);
        mLineHeight = a.getDimensionPixelSize(R.styleable.PageIndicatorLine_lineHeight,
                res.getDimensionPixelSize(R.dimen.dynamic_grid_page_indicator_line_height));
        a.recycle();
