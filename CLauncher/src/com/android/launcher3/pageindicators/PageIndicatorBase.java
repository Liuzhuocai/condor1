 ...
 */
public abstract class PageIndicatorBase extends FrameLayout implements PageIndicator {
    private CaretDrawable mCaretDrawable;

    protected int mNumPages = 1;

    public PageIndicatorBase(Context context, AttributeSet attrs, int defStyleAttr) {
