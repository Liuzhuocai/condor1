 ...
 */
public class PageIndicatorUnderline extends PageIndicatorBase {
    ...
    public void animateToAlpha(final float finalAlpha) {
        ...
        mAnimator = LauncherAnimUtils.ofPropertyValuesHolder(this,new PropertyListBuilder().alpha(finalAlpha).build())
...
//        super.onDraw(canvas);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        InvariantDeviceProfile idp = LauncherAppState.getInstance(getContext()).getInvariantDeviceProfile();
