...
public class Hotseat extends FrameLayout implements LogContainerProvider, Insettable {
    ...
    int getOrderInHotseat(int x, int y) {
        return mHasVerticalHotseat ? y : x;
    }

    /* Get the orientation specific coordinates given an invariant order in the hotseat. */
    int getCellXFromOrder(int rank) {
        // Perry: Hotseat arrange error: start
        return mHasVerticalHotseat ? 0 : mContent.getItemsCount();
        // Perry: Hotseat arrange error: end
    }

    int getCellYFromOrder(int rank) {
        // Perry: Resolve bug 5 and 6:start
        return mHasVerticalHotseat ? mContent.getItemsCount() : 0;
        // Perry: Resolve bug 5 and 6:end
    }
    // Perry: Hotseat reorder function: end
    ...
    void resetLayout(boolean hasVerticalHotseat) {
        ...
        mContent.setVerticalBarLayout(mHasVerticalHotseat);
        // Perry: Hotseat reorder function: end
