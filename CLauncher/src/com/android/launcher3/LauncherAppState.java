...
import com.condor.launcher.theme.ThemeChangeReceiver;
import com.condor.launcher.theme.ThemeIconProvider;
...
public class LauncherAppState {
    ...
    private LauncherAppState(Context context) {
        ...
        mContext = context;
        //liuzuo:add theme:start
        FeatureFlags.GO_DISABLE_WIDGETS = FeatureFlags.GO_DISABLE_WIDGETS && (FeatureFlags.GO_PROJECT&& !(Build.VERSION.SDK_INT ==Build.VERSION_CODES.O||Build.VERSION.SDK_INT ==Build.VERSION_CODES.O_MR1));
        IconProvider iconProvider = new ThemeIconProvider(context);
        //liuzuo:add theme:end
        mInvariantDeviceProfile = new InvariantDeviceProfile(mContext);
        mIconCache = new IconCache(mContext, mInvariantDeviceProfile,iconProvider);
        ...
        filter2.addAction("android.intent.action.THEME_CHANGED");
        filter2.addAction("condor.intent.action.THEME_CHANGED");
        mContext.registerReceiver(mThemeChangeReceiver, filter2);
        //antino:for theme:end
    ...
    public void onTerminate() {
        ...
        LiveIconsManager.obtain().release();
    ...
    public boolean isThemeChanged(){
        return mIconCache.isThemeChanged();
    }
    //antino:for theme:end
    //Bruce : add for settings row column :start
    public static void setInstanceNull() {
        INSTANCE = null;
    }
    //Bruce : add for settings row column :end
