...
public class OptionsPopupView extends ArrowPopup
    ...
    public static void showDefaultOptions(Launcher launcher, float x, float y) {
        ...
        options.add(new OptionItem(R.string.widget_button_text, R.drawable.ic_widget_button,
    ...
    public static boolean startWallpaperPicker(View v) {
        ...
        //liuzuo: add wallpaper picker : start
        ...
        launcher.getEditModePanel().switchToWallpaperPanel();
        //liuzuo: add wallpaper picker : end
        return true;
    }
