...
import static com.condor.launcher.CLauncherSettingsActivity.ALL;
import static com.condor.launcher.CLauncherSettingsActivity.FULLSCREEN_ACTIVITY;
...
public class SettingsActivity extends Activity {
    ...
    //liuzuo:add for go:start
    public static final String ICON_BADGING_PREFERENCE_KEY_GO = "pref_icon_badging_go";
    //liuzuo:add for go:end
    ...
    public static class LauncherSettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            //liuzuo: add for remove fast preference icon:begin
            int state = getArguments().getInt("state", ALL);
            if((FULLSCREEN_ACTIVITY & state) != 0){
                addPreferencesFromResource(R.xml.launcher_preferences);
            }else {
                addPreferencesFromResource(R.xml.launcher_preferences_fast);
            }
            //liuzuo: add for remove fast preference icon:end
