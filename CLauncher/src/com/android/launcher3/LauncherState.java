...
import com.android.launcher3.folder.FolderImportModeState;
...
import com.condor.launcher.editmode.EditModeState;
...
public class LauncherState {
    ...
    public static final int EDIT_MODE_PANEL = 1 << 6;
    public static final int PAGE_INDICATOR = 1 << 7;
    ...
    public static final LauncherState EDIT_MODE = new EditModeState(5);
    public static final LauncherState IMPORT_MODE = new FolderImportModeState(6);
    // Perry: Add edit mode panel: end
    ...
    public int getVisibleElements(Launcher launcher) {
        ...
        if (launcher.getDeviceProfile().isVerticalBarLayout()) {
            return HOTSEAT_ICONS | PAGE_INDICATOR | VERTICAL_SWIPE_INDICATOR;
        }
        return HOTSEAT_ICONS | PAGE_INDICATOR | HOTSEAT_SEARCH_BOX | VERTICAL_SWIPE_INDICATOR;
        // Perry: Add edit mode panel: end
    }
    ...
    public boolean requestFocus(Launcher launcher) {
        return false;
    }
