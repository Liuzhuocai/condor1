    ...
    public static Collection<CallApplicationData> getInstalledDialerApplications(Context context) {
        ...
        for (ResolveInfo resolveInfo : resolveInfoList) {
            ...
            if (activityInfo != null && !callPackageNames.contains(activityInfo.packageName)) {
                Log.d("liuzuo97","activityInfo.packageName="+activityInfo.packageName);
        ...
        List<ResolveInfo> allResolveInfoList = packageManager.queryIntentActivities(intentAll, PackageManager.MATCH_ALL);
        ...
        for (ResolveInfo resolveInfo : allResolveInfoList) {
            ...
            Log.d("liuzuo97","ResolveInfo activityInfo.packageName="+activityInfo.packageName);
