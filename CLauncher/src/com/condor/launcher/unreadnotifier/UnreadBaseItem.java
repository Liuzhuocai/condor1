...
//        return UnreadUtils.isPreferenceChecked(mContext, mPrefKey, mDefaultState);
//    }
...
//                }
                ...
                UnreadInfoManager.getInstance(mContext).updateUI(mContext, mCurrentCn, mType);
            }
        }.execute();
    ...
    private void saveValues(String value) {
        //Log.d("liuzuo98","saveValues mPrefKey="+mPrefKey+"  ,value="+value+"       "+Log.getStackTraceString(new Throwable()));
