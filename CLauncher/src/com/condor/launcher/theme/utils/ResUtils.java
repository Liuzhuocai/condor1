package com.condor.launcher.theme.utils;
...
public class ResUtils {
    ...
    public static Drawable getIconMipmap(String packageName, String resourceName,
                                         Context context, int iconDpi) {
        Drawable drawable = null;
        Resources resources = context.getResources();
        if (resources != null) {
            Log.i("resourceName",""+resourceName);
            int resId = resources.getIdentifier(resourceName, "mipmap",
                    packageName);
            if (resId == 0) {
                return null;
            }
